    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-shell-900 rounded-xl border border-shell-700 p-6 max-w-2xl w-full max-h-[85vh] overflow-y-auto">
        ...
        <div className="bg-[var(--dark-900)] rounded-lg p-6 mb-6">
          ...
          <div className="flex items-center justify-between text-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-white font-medium">MoltBot Guardian</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[var(--dark-900)] rounded-lg p-4">
            <h4 className="text-sm font-medium text-white mb-2">🦀 MoltBot Guardian (This Dashboard)</h4>
            <ul className="text-sm text-gray-400 space-y-1">
              <li>• Monitors agent activity locally</li>
              <li>• Session logs: <code className="text-cyan-400">~/.clawdbot/agents/*/sessions/</code></li>
              <li>• Behavioral baseline: <code className="text-cyan-400">~/.clawdbot/security/baseline.json</code></li>
          ...
          <div className="bg-[var(--dark-900)] rounded-lg p-4">
            ...
            <ul className="text-sm text-gray-400 space-y-1">
              ...
              <li>• MoltBot Guardian monitors all AI interactions equally</li>
            </ul>
          </div>
